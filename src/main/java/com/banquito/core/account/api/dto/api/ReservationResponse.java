...
public record ReservationResponse(
        ...
        BigDecimal commissionSubtotalQuote,
        BigDecimal chargedCommissionSubtotal,
        BigDecimal chargedCommissionTaxAmount,
        BigDecimal chargedCommissionTotalAmount,
        String feeTransactionUuid,
        String feeJournalEntryUuid,
